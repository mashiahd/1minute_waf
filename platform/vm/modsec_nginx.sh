...
if command -v curl &> /dev/null; then
    if ! source <(curl -s https://github.com/mashiahd/1minute_waf/blob/main/misc/utils.func); then
...
if [ "$curl_successful" != true ]; then
    ...
    wget -q -O utils.func https://github.com/mashiahd/1minute_waf/blob/main/misc/utils.func
